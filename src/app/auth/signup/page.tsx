      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-white rounded-3xl shadow-xl shadow-gray-100 border border-gray-100 p-8 text-center">
          ...
          <p className="text-gray-500 text-sm mb-6">
            أرسلنا رابط تأكيد إلى <span className="font-semibold text-gray-700">{email}</span>. افتح الرسالة وانقر على الرابط لتفعيل حسابك.
          </p>
          <Link
            href="/auth/signin"
      ...
      <div className="w-full max-w-md">
        ...
        <div className="flex justify-center mb-8">
          <Link href="/" className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400 mt-0.5">إنشاء حساب جديد</p>
            </div>
          </Link>
        </div>
        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-gray-100 border border-gray-100 p-8">
          <div className="mb-7 text-center">
            ...
            <p className="text-gray-400 mt-1 text-sm">أنشئ حسابك للوصول إلى لوحة التحكم</p>
          </div>
        ...
        <p className="text-center text-xs text-gray-400 mt-6">
          <Link href="/" className="hover:text-gray-600">العودة للموقع الرئيسي</Link>
        </p>
      </div>
    </div>
  );
